...
import { Page, Link, Block, Swiper, SwiperSlide, ListItem, List } from 'framework7-react';
	...
	>
		...
		>
			...
			<Block className="no-margin">
				<Swiper params={{ speed: 500, slidesPerView: 1.5, spaceBetween: 20 }}>
					<SwiperSlide>
						<Block
							className="no-margin"
							style={{
						...
						>
							...
							<p
								className="no-margin-bottom"
								style={{ fontWeight: '800', color: '#171F29', fontSize: '18px' }}
							>
								Nebula Grieving
							</p>
							<div
							...
							>
								<span style={{ fontWeight: '500', color: '#9AA7B8', fontSize: '12px' }}>
									Yara Barros
								</span>
								<span
									style={{ display: 'flex', fontWeight: '800', color: '#FFB319', fontSize: '12px' }}
								>
									<StarIcon />
